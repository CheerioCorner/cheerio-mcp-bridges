 ...
 * @param {boolean} [o.sandbox]            Run with terminal sandbox restrictions.
 * @param {boolean} [o.dangerouslyAllowAll] Auto-approve ALL tool permissions.
...
export function buildAgyArgs({
  ...
  if (dangerouslyAllowAll) args.push("--dangerously-skip-permissions");
